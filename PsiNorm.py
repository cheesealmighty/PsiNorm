...
#!/usr/bin/env python3
"""
PsiNorm Persentil Hesaplayıcı - Versiyon 1.9.2
...
------------------------------------
PsiNorm Percentile Calculator - Version 1.9.2
Copyright (C) 2017 Bilal Bahadır Akbulut & Yavuz Ayhan
...
def guiSettings():
    ...
    titleText = "PsiNorm Persentil Hesaplayıcı - 1.9.2 - Seçenekler "
...
def guiPatientInfo():
    import tkinter as tk
    titleText = "PsiNorm Persentil Hesaplayıcı - 1.9.2 - Hasta Bilgileri" 
    patientSex = None
...
def guiStartupMenu():
    ...
    from tkinter import messagebox
    import sys
    titleText = " PsiNorm Persentil Hesaplayıcı - 1.9.2"
...
def mainStartup(): #the mainStartup function
    print("""
================================================
 PsiNorm Persentil Hesaplayıcı - 1.9.2
================================================
""")
    timeGlobalization()
    guiPatientInfo()
